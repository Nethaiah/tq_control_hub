...
| AI with judgement | Achieved for two core features | OpenRouter supports CSV categorization and natural-language filter translation with confidence, fallbacks, and no direct ledger mutation. Monthly briefing/anomaly/forecast/OCR remain prototype surfaces or stored suggestion patterns. |
